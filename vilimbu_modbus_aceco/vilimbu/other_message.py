...
'''
import struct
from vilimbu.constants import ModbusStatus
from vilimbu.pdu import ModbusRequest
from vilimbu.pdu import ModbusResponse
from vilimbu.device import ModbusControlBlock, DeviceInformationFactory
from vilimbu.compat import byte2int, int2byte
...
class ReportSlaveIdRequest(ModbusRequest):
    ...
    def execute(self, context=None):
        ...
        if not reportSlaveIdData:
            ...
            identifier = identifier or b'vilimbu'
