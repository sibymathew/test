...
from vilimbu.client.asynchronous.thread import EventLoopThread
...
def reactor_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    from vilimbu.client.asynchronous.twisted import ModbusTcpClientProtocol
...
def io_loop_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    from vilimbu.client.asynchronous.tornado import AsyncModbusTCPClient as \
        Client
...
def async_io_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    """
    import asyncio
    from vilimbu.client.asynchronous.async_io import init_tcp_client
