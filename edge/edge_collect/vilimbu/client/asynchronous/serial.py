...
import logging
from vilimbu.client.asynchronous.factory.serial import get_factory
from vilimbu.transaction import ModbusRtuFramer, ModbusAsciiFramer, ModbusBinaryFramer, ModbusSocketFramer
from vilimbu.factory import ClientDecoder
from vilimbu.exceptions import ParameterException
from vilimbu.compat import IS_PYTHON3, PYTHON_VERSION
from vilimbu.client.asynchronous.schedulers import ASYNC_IO
...
class AsyncModbusSerialClient(object):
    ...
    To use do::
        ...
        from vilimbu.client.asynchronous.serial import AsyncModbusSerialClient
    """
    @classmethod
