...
from yw.edge.async.thread import EventLoopThread
...
def reactor_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    from yw.edge.async.twisted import ModbusTcpClientProtocol
...
def io_loop_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    from yw.edge.async.tornado import AsyncModbusTCPClient as \
        Client
...
def async_io_factory(host="127.0.0.1", port=Defaults.Port, framer=None,
    ...
    """
    import asyncio
    from yw.edge.async.async_io import init_tcp_client
