...
import logging
from yw.edge.async.factory.serial import get_factory
from yw.transaction import ModbusRtuFramer, ModbusAsciiFramer, ModbusBinaryFramer, ModbusSocketFramer
from yw.factory import ClientDecoder
from yw.exceptions import ParameterException
from yw.compat import IS_PYTHON3, PYTHON_VERSION
from yw.edge.async.schedulers import ASYNC_IO
...
class AsyncModbusSerialClient(object):
    ...
    To use do::
        ...
        from yw.edge.async.serial import AsyncModbusSerialClient
    """
    @classmethod
