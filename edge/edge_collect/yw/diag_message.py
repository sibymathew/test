...
Customized to read and log all the exceptions and do thorough diagnosis - YW scenarios
'''
import struct

from yw.constants import ModbusStatus, ModbusPlusOperation
from yw.yw_base import ModbusRequest
from yw.yw_base import ModbusResponse
from yw.device import ModbusControlBlock
from yw.exceptions import NotImplementedException
from yw.yw_utilities import pack_bitstring
...
class DiagnosticStatusSimpleResponse(DiagnosticStatusResponse):
    ...
    Customized to read and log more than 2 bytes of data - YW scenarios
    '''
